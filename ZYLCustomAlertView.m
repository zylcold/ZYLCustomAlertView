...
- (instancetype)initWithContentInputView:(UIViewZYLCustomInputView> *)contentView
{
    if(self = [super init]) {
...
- (void)setContentInputView:(UIViewZYLCustomInputView> *)contentInputView
{
